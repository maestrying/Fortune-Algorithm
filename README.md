...
* Постановка задачи
* Анализ алгоритма
    * Результаты исследования затраченных ресурсов памяти
    * Результаты исследования затраченного времени
* Заключение
* Список литературы
...
# Постановка задачи
1. Изучить алгоритм Форчуна и описать его в форме научного доклада.
2. Реализовать алгоритм, используя визуализатор в виде html-страницы, на которой будут находится интерактивные кнопки: ввод количества точек, кнопки с отображением фигур, выступающие в роли тестирования алгоритма, очистка всего поля. В роли выходных данных должна выступать эта же html-страница с визуальным отображением диаграммы Вороного.
3. Исследовать алгоритм на время и затраченные ресурсы памяти.
4. Результаты общей проделанной работы выложить на github.

# Анализ алгоритма
В рамках исследования была оценена производительность алгоритма. Использвалось два критерия: затраченное время и использованные ресурсы памяти. Тестирование было проведено на пяти различных наборах данных, каждый из которых содержит различное количество точек: 10, 100, 500, 1000, 5000 и 10000. Результаты тестирования позволили оценить производительность алгоритма и определить его преимущества и недостатки.
...
# Список литературы
https://habr.com/ru/post/315658/  
https://www.youtube.com/watch?v=dgEt9Go7GvE  
...
https://www.cs.mbrubeck/voronoi.html  
